...
function vegetablesCategory() {
    console.log(arrayItems.filter(arrayItems => arrayItems.category === "Vegetable"));
}
...
function fruitCategory() {
    console.log(arrayItems.filter(arrayItems => arrayItems.category === "Fruit"));
}
...
function proteinCategory() {
    console.log(arrayItems.filter(arrayItems => arrayItems.category === "Protein"));
}
...
function nutsCategory() {
    console.log(arrayItems.filter(arrayItems => arrayItems.category === "Nuts"));
}
...
function grainsCategory() {
    console.log(arrayItems.filter(arrayItems => arrayItems.category === "Grain"));
}
...
function dairyCategory() {
    console.log(arrayItems.filter(arrayItems => arrayItems.category === "Dairy"));
}
...
function calorieAbove100() {
    console.log(arrayItems.filter(arrayItems => arrayItems.calorie > 100));
}
...
function proteinSort() {
    console.log(arrayItems.sort((a, b) => a.protiens - b.protiens).reverse());
}
...
function cabSort() {
    console.log(arrayItems.sort((a, b) => a.cab - b.cab));
}
